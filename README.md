...
```
## OUTPUT:
<img width="809" height="401" alt="Screenshot 2025-11-16 082004" src="https://github.com/user-attachments/assets/9db5f2e0-eca8-4e2e-84c2-ed3e662ce383" />


## RESULT:
Thus, the program has been executed using CUDA to implement Bubble Sort and Merge sort in CUDA.
